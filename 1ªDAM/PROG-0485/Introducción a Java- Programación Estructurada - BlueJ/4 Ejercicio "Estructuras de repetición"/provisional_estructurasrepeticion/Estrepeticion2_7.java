...
public class Estrepeticion2_7
{
    public static void main(String[] args){
    /*que los sume que eso es importante y luego
     * me pide que además si alguno es mayor que tal ... bueno eso es el 
     * ejercicio anterior
     */
     ...
     * para esto de ir sumando.
     */
    if (sueldo > 10000){
        ricos = 1;
    }else{ ricos = 0;
    }
    for (contador = 1, sumatorio = 0; contador < 11; contador++){
